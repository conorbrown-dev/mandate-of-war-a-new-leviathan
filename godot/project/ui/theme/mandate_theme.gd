...
func _init() -> void:
	...
	set_type_variation("BodyLabel", "Label")
	set_type_variation("CommandLabel", "Label")
	set_type_variation("MajorHeading", "Label")
	set_type_variation("StrategicWarning", "Label")
...
func _install_panel_variations() -> void:
	...
	set_font_size("font_size", "BodyLabel", 14)
	set_color("font_color", "BodyLabel", Tokens.TEXT_PRIMARY)
	set_font_size("font_size", "CommandLabel", 16)
	set_color("font_color", "CommandLabel", Tokens.TEXT_PRIMARY)
	set_font_size("font_size", "MajorHeading", 28)
	set_color("font_color", "MajorHeading", Tokens.TEXT_PRIMARY)
	set_font_size("font_size", "StrategicWarning", 30)
	set_color("font_color", "StrategicWarning", Tokens.WARNING)
