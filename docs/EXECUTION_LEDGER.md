...
| Goal 05 — modding, asset pipeline, map editor | `ACTIVE` | Generated-unit development spawning and native map save/load are verified: map terrain/resources/spawns/entities round-trip, and a test mod's unit/mesh pair spawns with authored data (168 direct assertions; 2026-09-12). Dependency ordering/version enforcement, editor surface, and required review remain. |
