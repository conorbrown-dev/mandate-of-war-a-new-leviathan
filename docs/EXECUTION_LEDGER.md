...
| Goal 05 — modding, asset pipeline, map editor | `ACTIVE` | Generated-unit development spawning is verified: a test mod's unit/mesh pair is validated and spawned with authored data (167 direct assertions; 2026-09-12). Dependency ordering/version enforcement, map save/load, and the required review remain. |
