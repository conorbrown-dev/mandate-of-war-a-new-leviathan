...
| Goal 05 — modding, asset pipeline, map editor | `ACTIVE` | Generated-unit development spawning, native map save/load, dependency/version enforcement, and standalone Godot editor state are verified (170 direct assertions plus headless editor assertions; 2026-09-12). Native serializer wiring, rendered editor controls, and required review remain. |
